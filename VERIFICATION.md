...
- The v1 Studionet deployment remains historical evidence only. The v2 fix is deployed and its reviewer-specific reassessment lifecycles are linked in `docs/studionet-v2-evidence.md`.
